...
| Task | Municipality (competent authority) | ILS guideline owner | Applicant | Modeller / consultant | Omgevingsloket / software vendor |
|---|---|---|---|---|---|
| Adopting the ILS as a submission requirement | A/R | C | I | I | I |
| Managing and publishing the ILS | I | A/R | I | I | C |
| Setting acceptance criteria (thresholds) | A/R | C | I | I | C |
| Assessing admissibility | A/R | – | I | I | C |
| Running and assessing the checks | A/R | – | I | – | C |
| Feedback (BCF / request for correction) | A/R | – | I | I | – |

## Information production (delivering)

| Task | Municipality | Applicant | Modeller / consultant |
|---|---|---|---|
| Filling in the BIM execution plan / information production schedule | I | A | R |
| Producing the information model according to this ILS | – | A | R |
| Self-check with IDS before submitting | I | A | R |
| Submitting through the Omgevingsloket | I | A/R | C |
| Correcting after feedback | I | A | R |
