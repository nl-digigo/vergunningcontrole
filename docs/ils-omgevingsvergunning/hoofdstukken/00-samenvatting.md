...
De ILS is opgesteld binnen het VNG-programma **Beleidsmaatregel 13 - Vergunningverlening met BIM (3D/openBIM)** en volgt de opbouw van het **digiGO Toetsingskader ILS** en het **ILS-Referentiesjabloon** (Deel A: toelichting, Deel B: machineleesbaar datasjabloon).
