...
> Deze inventarisatie beschrijft per regel: de toets, de werkwijze, de informatiebehoefte (gebouwdata, mapping naar [ILS Ruimte / bsDD](https://search.bsdd.buildingsmart.org/uri/bsnl/Omgevingswet-Ruimten/0.3.0), omgevingsdata/geodata), de regelgevingsbron, de huidige toetstijd en opmerkingen. Regels #1–#6 betreffen het omgevingsplan (OPA), regels #7–#17 het Besluit bouwwerken leefomgeving (Bbl).
>
