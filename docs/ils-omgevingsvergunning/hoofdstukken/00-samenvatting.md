...
De ILS is opgesteld binnen het VNG-programma **Beleidsmaatregel 13 - Vergunningverlening met BIM (3D/openBIM/IFC)** en volgt de opbouw van het **digiGO Toetsingskader ILS** en het **ILS-Referentiesjabloon** (Deel A: toelichting, Deel B: machineleesbaar datasjabloon).
...
**Colofon.** Uitgegeven door de Vereniging van Nederlandse Gemeenten (VNG). Opgesteld door Lex Ransijn (VDCbase) in opdracht van VNG, in samenwerking met Pilot gemeenten, Software leveranciers, de stuurgroepleden.
