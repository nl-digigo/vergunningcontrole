...
|---|---|---|---|---|
| **AC1** | Het bestand is geldig IFC 4.3 (of IFC4 ADD2 TC1) in STEP-formaat, maximaal [250 / 1000] MB per container | Schemavalidatie (bijv. buildingSMART Validation Service)https://validate.buildingsmart.org/ | Ja | Niet ontvankelijk |
...
| **AC6** | De optioneel meegeleverde hoeveelheden (Qto) wijken niet meer dan [x]% af van de herberekende hoeveelheden (G5) | Tweeledige geometriecontrole, zie [Geometrische controle](#geometrie) | Ja (zodra de tooling beschikbaar is) | Signaal aan de beoordelaar |
| **AC7** | De bestandsnaam volgt de conventie uit de [Informatieproductiestandaard](#standaard) | Patrooncontrole | Ja | Signaal |

Waarden in tabel tussen [ ] kiest de gemeente bij het vaststellen van de ILS. Voorstel: 250 MB en 2%.
