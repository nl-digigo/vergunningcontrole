...
| bSDD *Omgevingswet-Ruimten* 0.3.0 | Klassen en `ObjectType`-waarden voor ruimtelijke objecten | [identifier.buildingsmart.org/uri/bsnl/Omgevingswet-Ruimten/0.3.0](https://identifier.buildingsmart.org/uri/bsnl/Omgevingswet-Ruimten/0.3.0) |
| ILS voor Ruimten in de Omgevingswet (digiGO) | Bron van de IDS-specificaties | digiGO, *ILS'en en richtlijnen* |
| IDS 1.0 (buildingSMART) | Formaat van de acceptatieregels | [github.com/buildingSMART/IDS](https://github.com/buildingSMART/IDS) |
| NL-SfB tabel 1 (2021) | Classificatie | bSDD |
| Naa.K.T. 2.4 | Materiaalbenaming | [search.bsdd.buildingsmart.org/uri/nkt/naakt/2.4](https://search.bsdd.buildingsmart.org/uri/nkt/naakt/2.4) |
| BAG, BRK, BGT (Kadaster/PDOK) | Pand-ID, verblijfsobject-ID, percelen, omgeving | [pdok.nl](https://www.pdok.nl/) |
| Omgevingsplan (Regels op de kaart, DSO) | Normwaarden voor checks #1–#6 | Omgevingsloket |
| Besluit bouwwerken leefomgeving | Normwaarden voor checks #7–#17 | wetten.nl |
...
| CHEK DBP-procesmodel en volwassenheidsmatrix | Volwassenheidsniveau van de gemeente | CHEK-project (EU Horizon) |
| STB 2025 | Fasering en disciplinecodes | BNA / NL Ingenieurs |
...
| Checkfiches (repo `vergunningcontrole`) | Laag 0–5 per check |
